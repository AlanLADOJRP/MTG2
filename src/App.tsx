...
const productsData: ProductsData = {
  "Draft Boosters": [
    { name: "Ravnica Remastered Draft", price: 175.99, image: "/images/ravnica_remastered_draft.png" },
    { name: "Dominaria United Draft", price: 111.46, image: "/images/dominaria_united_draft.png" },
    { name: "Midnight Hunt Draft", price: 95.78, image: "/images/midnight_hunt_draft.png" },
  ],
  "Set Boosters": [
    { name: "March Of The Machine Set", price: 168.99, image: "/images/march_of_the_machine_set.png" },
    { name: "Mystery Booster Convention", price: 193.49, image: "/images/mystery_booster_convention.png" },
  ],
  "Play Boosters": [
    { name: "Murders at Karlov Manor Play", price: 116.10, image: "/images/murders_at_karlov_manor_play.png" },
  ],
  "Collector Boosters": [
    { name: "Murder at Karlov Manor Collector", price: 252.89, image: "/images/murder_at_karlov_manor_collector.png" },
    { name: "Ravnica Remastered Collector", price: 525, image: "/images/ravnica_remastered_collector.png" },
    { name: "Commander Masters Collector", price: 314.46, image: "/images/commander_masters_collector.png" },
  ],
  "Commander Decks": [
    { name: "Final Fantasy — Counter Blitz", price: 43.54, image: "/images/counter_blitz.png" },
    { name: "Final Fantasy — Limit Break", price: 57.16, image: "/images/limit_break.png" },
    { name: "Final Fantasy — Scions & Spellcraft", price: 45.80, image: "/images/scions_spellcraft.png" },
  ],
  "Prerelease": [
    { name: "Lord of the Rings Prerelease", price: 82, image: "/images/lord_of_the_rings_prerelease.png" },
  ],
  "Secret Lair": [
    { name: "Non Foil - Outlaw Anthology Vol. 2: Sinister Scoundrels", price: 42.75, image: "/images/secret_lair_showcase_awbo_step_and_compleat.png" },
    { name: "Non Foil - Prints of Darkness", price: 49.95, image: "/images/secret_lair_showcase_awbo_step_and_compleat.png" },
    { name: "Non Foil - Princess Bride", price: 212.07, image: "/images/secret_lair_showcase_awbo_step_and_compleat.png" },
    { name: "Non Foil - Life Breaks Free", price: 219.91, image: "/images/secret_lair_showcase_awbo_step_and_compleat.png" },
    { name: "Non Foil - Optimus Prime vs Megatron", price: 79.72, image: "/images/secret_lair_showcase_awbo_step_and_compleat.png" },

    { name: "Showcase AWBO Step and Compleat", price: 50.84, image: "/images/secret_lair_showcase_awbo_step_and_compleat.png" },
    { name: "Traditional Foil - Doctor Who: Regeneration", price: 300, image: "/images/secret_lair_the_scorpion_god_traditional_foil.png" },
    { name: "Traditional Foil - Tomb Raider", price: 187.38, image: "/images/secret_lair_the_scorpion_god_traditional_foil.png" },
    { name: "Traditional Foil - Just Add Milk: Second Helpings", price: 60.77, image: "/images/secret_lair_the_scorpion_god_traditional_foil.png" },
    { name: "Traditional Foil - The Scorpion God", price: 8.88, image: "/images/secret_lair_the_scorpion_god_traditional_foil.png" },
    { name: "Traditional Foil - Not a Wolf", price: 64.99, image: "/images/not_a_wolf_traditional_foil.png" },
    { name: "Rainbow Foil - SLxFallout Vault Boy", price: 71.86, image: "/images/secret_lair_slxfallout_vault_boy_rainbow_foil.png" },
    { name: "Rainbow Foil - Bloomburrow", price: 67.95, image: "/images/showcase_bloomburrow_rainbow_foil.png" },
    { name: "Rainbow Foil - Phoebe Wahl", price: 48.85, image: "/images/phoebe_wahl_rainbow_foil.png" },
    { name: "Rainbow Foil - Braindead: Staples", price: 52.53, image: "/images/secret_lair_x_braindead_staples.png" },
    { name: "Rainbow Foil - Artist Series: Rovina Cal", price: 75.02, image: "/images/artist_series_rovena_cal_rainbow_foil.png" },
    { name: "Rainbow Foil - Prismatic Nightmares", price: 129.84, image: "/images/not_a_wolf_traditional_foil.png" },
  ],
  "Secret Lair Decks": [
    { name: "Angels: They're Just Like Us but Cooler and with Wings Deck", price: 499, image: "/images/angels_deck.png" },
    { name: "From Cute to Brute Deck", price: 219.98, image: "/images/secret_lair_cute_to_brute_commander.png" },
  ],
  "Others": [
    { name: "Dominaria United Jumpstart Boosters (3x)", price: 6.39, image: "/images/dominaria_united_jumpstart_boosters_3x.png" },
    { name: "Murder at Karlov Manor Bundle", price: 39.39, image: "/images/murder_at_karlov_manor_bundle.png" },
    { name: "Pioneer Challenger Decks", price: 169.90, image: "/images/pioneer_challenger_decks.png" },
    { name: "Crimson Vow Gift Bundle", price: 79.84, image: "/images/crimson_vow_gift_bundle.png" },
    { name: "Commander Collection: Green - Premium", price: 76.90, image: "/images/Commander_Collection_Green_Premium.png" },
  ],
};
